...
class HerbProfit(commands.Cog):
    ...
    @app_commands.describe(
        ...
        compost="Type of compost (None/Compost/Supercompost/Ultracompost)",
    ...
    async def herb_profit(self, interaction: discord.Interaction, farming_level: int, patches: int, weiss: bool, trollheim: bool, hosidius: bool, fortis: bool, compost: str, kandarin_diary: str, kourend: bool, magic_secateurs: bool, farming_cape: bool, bottomless_bucket: bool):
        try:
